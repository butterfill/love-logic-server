 ...
 *
 * NB : MODIFIED FOR ZOXIY --- pasted incomplete 
 * materialize theme at end; also cut a few bits we don't use
 *
 * Retain this if updating!
 * 
 * Date: 2016-02-11
 */
...
JSONEditor.defaults.themes.materializecss = JSONEditor.AbstractTheme.extend({
  ...
  getButton: function(text, icon, title) {
    ...
    el.className += 'btn-flat waves-effect waves-grey';
    return el;
  },
  getTable: function() {
